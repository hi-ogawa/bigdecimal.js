...
describe('Equals JDK', function () {
    ...
    it('equals test', function () {
        const testValues = [
            ...
            [Big('123456789123456789123'), Big(JSBI.BigInt('123456789123456789123'))],
            [Big('123456789123456789123'), Big(JSBI.BigInt('123456789123456789124'))],
            ...
            [Big(JSBI.BigInt(2) ** JSBI.BigInt(65)), Big('36893488147419103232')],
